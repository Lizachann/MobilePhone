...
public class Calculator_Answer {
    //	-----------------------------------------------------------------------------------------
...
//	-----------------------------------------------------------------------------------------
    ...
    public static Double answerMain(String expression){
        ...
        for (int i=0; i<expression.length(); i++) {
            ...
            if (current == '(') { // Case of '('
            ...
            } else if (current == '*' || current == '/') { // Case of '*' or '/'

                if (stack.isEmpty() || "(".equals(stack.peek())) {  //stack.peek() is used to retrieve or fetch the first element of the Stack
                    stack.push(current + "");
                } else {
                    while (!stack.isEmpty() && ("*".equals(stack.peek()) || "/".equals(stack.peek()))) {
                        list.add(stack.pop());
            ...
            } else if (current >= 48 && current <= 57) { // Case of '0' ~ '9' or '.'
                ...
                if (i + 2 < expression.length() && "sin".equals(expression.substring(i, i + 3))) {
                    ...
                    if (i + 1 < expression.length() && (expression.charAt(i + 1) >= 48 && expression.charAt(i + 1) <= 57)) {
                        ...
                        if (current == '\u03C0') list.add(Double.parseDouble(temp) * Math.PI);
                        else list.add(Double.parseDouble(temp) * Math.E);
                        i = j - 1;
                    }
                    else {
                        list.add(current == 'e' ? Math.E : Math.PI);
                    }
                } else if (current == '\u221A') {
                    list.add("root");
